...
local s = VLib:Window("pa1n HUB", "Shindo Life", "")
...
gui:Button("GUI by VG HUB (Click to Execute)",function()
...
gui:Button("GUI by Solaris Hub (Click to Execute)",function()
...
scr:Button("ServerHop Pumpkin Farm",function()
...
scr:Button("Cristmas NPC FARM",function()
getgenv().AutoFarm = true
loadstring(game:HttpGet("https://senseijoshy.com/Side-Scripts/SLChristmas.lua"))()
end)
