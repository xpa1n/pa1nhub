...
local s = VLib:Window("pa1n HUB", "YBA", "")
...
gui:Button("CARLEY HUB BY YAKI (Click to Execute)",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/Yaki-0/Carley-Hub/main/YBA.lua", true))()
end)


gui:Button("GUI CRACKED BY Tobias020108Back (Click to Execute)",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/Tobias020108Back/YBA/main/Yba/All/In/One/NonAutoExec"))() 
end)

gui:Button("GUI BY kolgie (Click to Execute)",function()
...
scr:Button("SERVERHOP ITEM FARM by SPOOKY (Click to Execute)",function()
getgenv().Toggle = true
getgenv().Invisible = false
loadstring(game:HttpGet("https://raw.githubusercontent.com/lmmake/Carely-Hub/main/YBA%20Script"))()
end)

scr:Button("ITEM ESP (Click to Execute)",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/toeydeklnw/HUB-obfuscator/main/YBA%20ITEMS%20ESP"))()
end)

scr:Button("FE KICK ALL & SERVER HOP (Click to Execute)",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/lmmake/YBA-Sutff/main/Serverhop%20with%20kick"))()
end)
